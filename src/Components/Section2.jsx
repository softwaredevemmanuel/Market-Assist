...
const Section2 = () => {
  return (
    <div className="my-[110px] bg-[#F5FBF3]  h-[1000px]">
      <div>
        <Section1 />
      </div>
      ...
      <div className="flex px-[100px] items-center   justify-between py-[70px]">
        <div className="flex flex-col h-[494px] gap-10">
          ...
          <div className="flex gap-10">
            <button className="bg-[#002100] w-[240px] text-[20px] text-white font-medium rounded-[30px]">Get Started</button>
            <button className="w-[240px] h-[52px] text-[20px] font-medium rounded-[30px] border-[#002100] text-[#002100] border-[1px]">Get Started</button>
          </div>

          <div className="flex flex-col gap-4">
            <div><h1 className="text-[18px] text-[#00210099]">Download the MarketAssist App</h1></div>
